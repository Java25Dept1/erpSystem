 ...
 * @author 
 */
@TableName(value="stockapplydetails")
public class StockapplydetailsPojo implements Serializable {
	/**
     * 请购单编号
     */
	...
	public StockapplydetailsPojo() {
		super();
	}

	public StockapplydetailsPojo(String appid, Integer apdrows, String apdmateridlid, String apdmateridlname,
	...
	public StockapplydetailsPojo(Integer apdrows, String apdmateridlid, String apdmateridlname, String apdmodel,
	...
	public StockapplydetailsPojo(String apdmateridlid, String apdmateridlname, String apdmodel, String apdunit,
	...
	public String toString() {
		return "Stockapplydetails [appid=" + appid + ", apdrows=" + apdrows + ", apdmateridlid=" + apdmateridlid
				+ ", apdmateridlname=" + apdmateridlname + ", apdmodel=" + apdmodel + ", apdunit=" + apdunit
				+ ", apdnum=" + apdnum + ", apdstandardprice=" + apdstandardprice + ", apdstandardmoney="
				+ apdstandardmoney + ", apdprice=" + apdprice + ", apdintomoney=" + apdintomoney + ", apddemanddate="
				+ apddemanddate + ", apdstockdate=" + apdstockdate + ", apdnotnum=" + apdnotnum + ", apdoriginid="
				+ apdoriginid + ", apdorigintype=" + apdorigintype + ", apdremark=" + apdremark + ", enables=" + enables
